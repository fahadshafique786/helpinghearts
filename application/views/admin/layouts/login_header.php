...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="<?php echo ADMIN_ASSET_URL; ?>images/favicon.png" type="image/x-icon">
    <link rel="shortcut icon" href="<?php echo ADMIN_ASSET_URL; ?>images/favicon.png" type="image/x-icon">
