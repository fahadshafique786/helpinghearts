...
<html lang="en">
  ...
  <body>
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">AR-Rahman<span>  Foundation </span></a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	...
	        	<li class="nav-item"><a href="#donatenow" class="nav-link">DONATE NOW</a></li>
	        	<li class="nav-item"><a href="#userRequest" class="nav-link">USER REQUEST</a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
    ...
    <div class="hero-wrap"  id="home" style="background-image: url('images/bg_1.jpg');" data-stellar-background-ratio="0.5">
    ...
    <section class="ftco-section ftco-no-pt ftco-no-pb ftco-volunteer"  id="ourmission"  >
    	<div class="container">
    		<div class="row">
    ...
    <section class="services-section py-5 py-md-0 bg-light"  id="donatenow" >
      <div class="container">
